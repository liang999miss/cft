...
import com.cft.weixin.bean.card.CardType;
import com.cft.weixin.bean.card.CashCard;
import com.cft.weixin.bean.card.DiscountCard;
import com.cft.weixin.bean.card.GeneralCouponCard;
import com.cft.weixin.bean.card.GiftCard;
import com.cft.weixin.bean.card.GrouponCard;
import com.cft.weixin.bean.card.batchget.BatchGet;
import com.cft.weixin.bean.card.batchget.BatchGetResult;
import com.cft.weixin.bean.card.code.checkcode.CodeCheckCode;
import com.cft.weixin.bean.card.code.checkcode.CodeCheckCodeResult;
import com.cft.weixin.bean.card.code.consume.CodeConsume;
import com.cft.weixin.bean.card.code.consume.CodeConsumeResult;
import com.cft.weixin.bean.card.code.decrypt.CodeDecrypt;
import com.cft.weixin.bean.card.code.decrypt.CodeDecryptResult;
import com.cft.weixin.bean.card.code.deposit.CodeDeposit;
import com.cft.weixin.bean.card.code.deposit.CodeDepositResult;
import com.cft.weixin.bean.card.code.get.CodeGet;
import com.cft.weixin.bean.card.code.get.CodeGetResult;
import com.cft.weixin.bean.card.code.getdepositcount.CodeGetDepositCount;
import com.cft.weixin.bean.card.code.getdepositcount.CodeGetDepositCountResult;
import com.cft.weixin.bean.card.code.unavailable.CodeUnavailable;
import com.cft.weixin.bean.card.code.update.CodeUpdate;
import com.cft.weixin.bean.card.create.Create;
import com.cft.weixin.bean.card.create.CreateResult;
import com.cft.weixin.bean.card.get.AbstractResult;
import com.cft.weixin.bean.card.get.GetCashResult;
import com.cft.weixin.bean.card.get.GetDiscountResult;
import com.cft.weixin.bean.card.get.GetGeneralCouponResult;
import com.cft.weixin.bean.card.get.GetGrouponResult;
import com.cft.weixin.bean.card.get.GetResult;
import com.cft.weixin.bean.card.landingpage.create.LandingPageCreate;
import com.cft.weixin.bean.card.landingpage.create.LandingPageCreateResult;
import com.cft.weixin.bean.card.modifystock.ModifyStock;
import com.cft.weixin.bean.card.mpnews.gethtml.MpNewsGetHtml;
import com.cft.weixin.bean.card.mpnews.gethtml.MpNewsGetHtmlResult;
import com.cft.weixin.bean.card.paycell.set.PaySellSet;
import com.cft.weixin.bean.card.qrcode.create.QrCodeCreate;
import com.cft.weixin.bean.card.qrcode.create.QrCodeCreateMultiple;
import com.cft.weixin.bean.card.qrcode.create.QrCodeCreateResult;
import com.cft.weixin.bean.card.testwhitelist.set.TestWhiteListSet;
import com.cft.weixin.bean.card.update.UpdateCash;
import com.cft.weixin.bean.card.update.UpdateDiscount;
import com.cft.weixin.bean.card.update.UpdateGeneralCoupon;
import com.cft.weixin.bean.card.update.UpdateGift;
import com.cft.weixin.bean.card.update.UpdateGroupon;
import com.cft.weixin.bean.card.update.UpdateResult;
import com.cft.weixin.bean.card.user.getcardlist.UserGetCardList;
import com.cft.weixin.bean.card.user.getcardlist.UserGetCardListResult;
