...
import com.cft.weixin.bean.media.Media;
import com.cft.weixin.bean.message.ApiAddTemplateResult;
import com.cft.weixin.bean.message.Article;
import com.cft.weixin.bean.message.CurrentAutoreplyInfo;
import com.cft.weixin.bean.message.GetAllPrivateTemplateResult;
import com.cft.weixin.bean.message.GetIndustryResult;
import com.cft.weixin.bean.message.MessageSendResult;
import com.cft.weixin.bean.message.Uploadvideo;
import com.cft.weixin.bean.message.massmessage.MassMessage;
import com.cft.weixin.bean.message.message.Message;
import com.cft.weixin.bean.message.preview.Preview;
import com.cft.weixin.bean.message.templatemessage.TemplateMessage;
import com.cft.weixin.bean.message.templatemessage.TemplateMessageResult;
import com.cft.weixin.bean.message.templatemessage.WxopenTemplateMessage;
