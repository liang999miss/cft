...
import com.cft.weixin.bean.shakearound.account.auditstatus.AccountAuditStatusResult;
import com.cft.weixin.bean.shakearound.account.register.AccountRegister;
import com.cft.weixin.bean.shakearound.account.register.AccountRegisterResult;
import com.cft.weixin.bean.shakearound.device.applyid.DeviceApplyId;
import com.cft.weixin.bean.shakearound.device.applyid.DeviceApplyIdResult;
import com.cft.weixin.bean.shakearound.device.applystatus.DeviceApplyStatus;
import com.cft.weixin.bean.shakearound.device.applystatus.DeviceApplyStatusResult;
import com.cft.weixin.bean.shakearound.device.bindlocation.DeviceBindLocation;
import com.cft.weixin.bean.shakearound.device.bindlocation.DeviceBindLocationResult;
import com.cft.weixin.bean.shakearound.device.bindpage.DeviceBindPage;
import com.cft.weixin.bean.shakearound.device.bindpage.DeviceBindPageResult;
import com.cft.weixin.bean.shakearound.device.group.add.DeviceGroupAdd;
import com.cft.weixin.bean.shakearound.device.group.add.DeviceGroupAddResult;
import com.cft.weixin.bean.shakearound.device.group.adddevice.DeviceGroupAddDevice;
import com.cft.weixin.bean.shakearound.device.group.adddevice.DeviceGroupAddDeviceResult;
import com.cft.weixin.bean.shakearound.device.group.delete.DeviceGroupDelete;
import com.cft.weixin.bean.shakearound.device.group.delete.DeviceGroupDeleteResult;
import com.cft.weixin.bean.shakearound.device.group.deletedevice.DeviceGroupDeleteDevice;
import com.cft.weixin.bean.shakearound.device.group.deletedevice.DeviceGroupDeleteDeviceResult;
import com.cft.weixin.bean.shakearound.device.group.getdetail.DeviceGroupGetDetail;
import com.cft.weixin.bean.shakearound.device.group.getdetail.DeviceGroupGetDetailResult;
import com.cft.weixin.bean.shakearound.device.group.getlist.DeviceGroupGetList;
import com.cft.weixin.bean.shakearound.device.group.getlist.DeviceGroupGetListResult;
import com.cft.weixin.bean.shakearound.device.group.update.DeviceGroupUpdate;
import com.cft.weixin.bean.shakearound.device.group.update.DeviceGroupUpdateResult;
import com.cft.weixin.bean.shakearound.device.search.DeviceSearch;
import com.cft.weixin.bean.shakearound.device.search.DeviceSearchResult;
import com.cft.weixin.bean.shakearound.device.update.DeviceUpdate;
import com.cft.weixin.bean.shakearound.device.update.DeviceUpdateResult;
import com.cft.weixin.bean.shakearound.lottery.addlotteryinfo.LotteryAddLotteryInfo;
import com.cft.weixin.bean.shakearound.lottery.addlotteryinfo.LotteryAddLotteryInfoResult;
import com.cft.weixin.bean.shakearound.lottery.querylottery.LotteryQueryLotteryResult;
import com.cft.weixin.bean.shakearound.lottery.setprizebucket.LotterySetPrizeBucket;
import com.cft.weixin.bean.shakearound.lottery.setprizebucket.LotterySetPrizeBucketResult;
import com.cft.weixin.bean.shakearound.material.add.MaterialAddResult;
import com.cft.weixin.bean.shakearound.material.add.MediaType;
import com.cft.weixin.bean.shakearound.page.add.PageAdd;
import com.cft.weixin.bean.shakearound.page.add.PageAddResult;
import com.cft.weixin.bean.shakearound.page.delete.PageDelete;
import com.cft.weixin.bean.shakearound.page.delete.PageDeleteResult;
import com.cft.weixin.bean.shakearound.page.search.PageSearch;
import com.cft.weixin.bean.shakearound.page.search.PageSearchResult;
import com.cft.weixin.bean.shakearound.page.update.PageUpdate;
import com.cft.weixin.bean.shakearound.page.update.PageUpdateResult;
import com.cft.weixin.bean.shakearound.relation.search.RelationSearch;
import com.cft.weixin.bean.shakearound.relation.search.RelationSearchResult;
import com.cft.weixin.bean.shakearound.statistics.device.StatisticsDevice;
import com.cft.weixin.bean.shakearound.statistics.device.StatisticsDeviceResult;
import com.cft.weixin.bean.shakearound.statistics.devicelist.StatisticsDeviceList;
import com.cft.weixin.bean.shakearound.statistics.devicelist.StatisticsDeviceListResult;
import com.cft.weixin.bean.shakearound.statistics.page.StatisticsPage;
import com.cft.weixin.bean.shakearound.statistics.page.StatisticsPageResult;
import com.cft.weixin.bean.shakearound.statistics.pagelist.StatisticsPageList;
import com.cft.weixin.bean.shakearound.statistics.pagelist.StatisticsPageListResult;
import com.cft.weixin.bean.shakearound.user.getshakeinfo.UserGetShakeInfo;
import com.cft.weixin.bean.shakearound.user.getshakeinfo.UserGetShakeInfoResult;
import com.cft.weixin.client.LocalHttpClient;
import com.cft.weixin.util.JsonUtil;
import com.cft.weixin.util.StreamUtils;
