...
import com.cft.weixin.bean.user.FollowResult;
import com.cft.weixin.bean.user.GetblacklistResult;
import com.cft.weixin.bean.user.Group;
import com.cft.weixin.bean.user.TagsCreatResult;
import com.cft.weixin.bean.user.TagsGetResult;
import com.cft.weixin.bean.user.TagsGetidlistResult;
import com.cft.weixin.bean.user.User;
import com.cft.weixin.bean.user.UserInfoList;
import com.cft.weixin.bean.user.UserTagGetResult;
import com.cft.weixin.client.LocalHttpClient;
import com.cft.weixin.util.EmojiUtil;
